...
app.config['SECRET_KEY'] = 'mixing-secret'

logging.basicConfig(level=logging.INFO, format='%(asctime)s - %(name)s - %(levelname)s - %(message)s')
logger = logging.getLogger('MixingApp')
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .badge {
            ...
            background: rgba(59, 130, 246, 0.2); color: #60a5fa; font-size: 13px;
...
<body>
    <div class="card">
        ...
        <h1>{{ dept_name }}</h1>
        <p>搅拌设备智能化工作界面开发中<br>本科室服务已就绪，静态资源从 <code>/static</code> 提供</p>
        <div class="meta">
